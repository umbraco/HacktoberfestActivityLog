...
- 2022-10-31 - Adam Werner - New package - [on GitHub](https://github.com/adam-werner/xStatic.AWSS3) / [on Our](https://our.umbraco.com/packages/backoffice-extensions/xstatic-deploy-to-aws-s3/) - xStatic Deploy to AWS S3: An xStatic plugin for deploying an Umbraco web site to an AWS S3 bucket
- 2022-10-31 - Adam Werner - New package - [on GitHub](https://github.com/adam-werner/Our.Umbraco.StorageProviders.AWSS3) / [on Our](https://our.umbraco.com/packages/collaboration/aws-s3-media-file-system-provider/) - AWS S3 Media File System Provider: The AWS S3 Storage provider has an implementation of the Umbraco IFileSystem that connects to an AWS S3 Storage container.
